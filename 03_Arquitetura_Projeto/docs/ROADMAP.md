...
## 🧠 NOTA CRÍTICA: Intelligence Layer

Este roadmap é **extendido e operacionalizado** pela **[Intelligence Layer](../intelligence/)**, que deve ser consultada ANTES e DURANTE a execução:

| Documento | Quando Usar | Propósito |
|-----------|-------------|-----------|
| [01_Edital_Deep_Analysis](../intelligence/01_Edital_Deep_Analysis.md) | **Antes de codar** | Brechas, tie-breakers, scoring |
| [02_Aggressive_BI](../intelligence/02_Aggressive_BI_Intelligence.md) | Pitch preparation | Sponsor profiling, TAM/SAM/SOM |
| [03_Knowledge_Synthesis](../intelligence/03_Knowledge_Synthesis_OSINT.md) | Decisões contínuas | Frameworks Macro-Meso-Micro |
| [04_Real_Execution_Roadmap](../intelligence/04_Real_Execution_Roadmap.md) | **Durante competição** | Decision trees, triggers, checkpoints |

> ⚠️ **WARNING**: O cronograma abaixo é a **base técnica**. A execução real segue o documento 04 com gatilhos de inteligência e protocolos de contingência.
