...
![AI](https://img.shields.io/badge/AI-OpenAI%20API-412991?style=for-the-badge&logo=openai)
![Status](https://img.shields.io/badge/Status-Pre--Competition-yellow?style=for-the-badge)
![Date](https://img.shields.io/badge/Date-18--19%20April%202026-red?style=for-the-badge&calendar)
![Prize](https://img.shields.io/badge/Prize-R%248.000-green?style=for-the-badge&logo=money)
...
flowchart TB
    subgraph CLIENT["Camada Cliente"]
        UI["Páginas Mendix<br/>(Atlas UI)"]
    end

    subgraph SERVER["Camada Servidor"]
        MF["Microflows<br/>Mendix"]
        DB["Database<br/>(PostgreSQL)"]
    end

    subgraph AI["Camada IA"]
        API["OpenAI API<br/>(GPT-4o)"]
    end

    subgraph BACKUP["Camada Backup"]
        MOCK["Dados Mock<br/>(CSV)"]
    end
